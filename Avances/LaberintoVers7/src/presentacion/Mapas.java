...
//	private JLabel mapa3;
	...
	public void iniciarComponentes() {
		...
		ImageIcon iconButon1 = new ImageIcon("imagenes/MapaAlessandro.png");
		btn1 = new JButton(iconButon1);
		panel.add(btn1, BorderLayout.WEST);
		btn1.addActionListener(this);

		ImageIcon iconButon2 = new ImageIcon("imagenes/MapaGabriel.png");
		btn2 = new JButton(iconButon2);
		panel.add(btn2, BorderLayout.CENTER);
		btn2.addActionListener(this);

		ImageIcon iconButon3 = new ImageIcon("imagenes/MapaAugusto.png");
